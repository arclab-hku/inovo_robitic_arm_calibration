...
# m2.add(Waypoint(0.006, 0.354, 0.165, math.pi, 0.02 * math.pi, 0.5 * math.pi) \
...
# m3.add(Waypoint(-0.129, 0.325, 0.153, math.pi, 0.04 * math.pi, 0.524 * math.pi) \
#     .constrain_joint_acceleration(0.2) \
#     .constrain_joint_velocity(0.2) \
#     .set_blend(BLENDL, 0.5) \
#     .set_linear())
...
m2.add(Waypoint(0.006, 0.354, 0.215, math.pi, 0.02 * math.pi, 0.5 * math.pi) \
    .constrain_joint_acceleration(0.2) \
    .constrain_joint_velocity(0.2) \
    .set_blend(BLENDL, 0.5) \
    .set_linear())
...
m3.add(Waypoint(-0.129, 0.325, 0.203, math.pi, 0.04 * math.pi, 0.524 * math.pi) \
    .constrain_joint_acceleration(0.2) \
    .constrain_joint_velocity(0.2) \
    .set_blend(BLENDL, 0.5) \
    .set_linear())
...
# Back to home point
m4.add(Waypoint(0.007, 0.363, 0.555, math.pi, 0, 0.5 * math.pi) \
    .constrain_joint_acceleration(0.3) \
    .constrain_joint_velocity(0.3) \
    .set_blend(BLENDL, 0.5) \
    .set_linear())
