...
m3.add(Waypoint(-0.189, 0.331, 0.165, 0.772 * math.pi, 0.0395 * math.pi, 0.667 * math.pi) \
    .constrain_joint_acceleration(0.8) \
    .constrain_joint_velocity(0.8) \
    .set_blend(BLENDL, 0.5) \
    .set_linear())
m3.add(Waypoint(-0.153, 0.359, 0.133, 0.789 * math.pi, 0.011 * math.pi, 0.685 * math.pi) \
    .constrain_joint_acceleration(0.8) \
    .constrain_joint_velocity(0.8) \
    .set_blend(BLENDL, 0.5) \
    .set_linear())
